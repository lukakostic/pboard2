...
class _Header_{
   ...
   headerTitle_oninput(){
      ...
      boardsUpdated([mainView.id],false,2); ///////////TODO add for cases like this, im just updating a value not deleting/adding a board. It should update and redraw text but notrebuild whole dom!
   }
