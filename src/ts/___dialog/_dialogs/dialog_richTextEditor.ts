...
class _dialog_richTextEditor_ extends DialogInterface {
   ...
   textTitle : HTMLInputElement;
	...
	save(now:boolean = false):void{
		...
		boardsUpdated(now?UpdateSaveType.SaveNow:UpdateSaveType.AutoSave, dialogManager.boardID,[dialogManager.boardID]);  
	}
...
allDialogs.richTextEditor = _dialog_richTextEditor_;