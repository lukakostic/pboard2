...
let selectedExtensionInEditor :string = "";
...
function extensionEditorSave(){
    ...
    let s = (<HTMLInputElement> EbyId('extensionEditorInput')).value
    let desc = (<HTMLInputElement> EbyId('extensionEditorDescription')).value
    let code = (<HTMLInputElement> EbyId('extensionEditorCode')).value
...
function selectExtensionToEdit(id){
    ...
    if(id!=""){
        ...
        (<HTMLInputElement> EbyId('extensionEditorInput')).value = pb.extensions[id].name;
        (<HTMLInputElement> EbyId('extensionEditorDescription')).value = pb.extensions[id].description;
        (<HTMLInputElement> EbyId('extensionEditorCode')).value = pb.extensions[id].code;
        ...
        (<HTMLInputElement> EbyId('extensionEditorInput')).value = "";
        (<HTMLInputElement> EbyId('extensionEditorDescription')).value = "";
        (<HTMLInputElement> EbyId('extensionEditorCode')).value = "";
    }
...
function extensionEditorSearched(){
    let s = (<HTMLInputElement> EbyId('extensionEditorSearch')).value;
